              ...
              <div class="card border-white shadow-sm p-sm-3">
                <nav class="nav tab-content mb-4" role="tablist">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist"> 
                        ...
                        <a class="nav-link" id="nav-currency-link" data-bs-toggle="tab" data-bs-target="#nav-currency" type="button" role="tab" aria-controls="nav-currency" aria-selected="true" href="#">${ __('Patient') }</a>
                        <a class="nav-link" id="nav-payout-link" data-bs-toggle="tab" data-bs-target="#nav-payout" type="button" role="tab" aria-controls="nav-payout" aria-selected="true"  href="#">${ __('Medications') }</a>
                        <a class="nav-link d-none" id="nav-tax-link" data-bs-toggle="tab" data-bs-target="#nav-tax" type="button" role="tab" aria-controls="nav-tax" aria-selected="true"  href="#">${ __('Tax') }</a>
                    </div>
                </nav>
                <div class="card-body tab-content" id="nav-tabContent">
                    ...
                    <h4 id="gen" class="card-title mb-4">${ __('Patient settings') }</h4>

                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group row mb-3 mt-1">
                          <label class="col-sm-3 col-form-label">${ __('Custom fields') }</label>
                          <div class="col-sm-9">
                            <textarea id="section_fields" type="text" class="form-control inp" name="section_1" data-type="text" rows=12></textarea>
                            <p class="form-text"> ${ __('Provide list of custom fields for patient card (one field per line)') } </p>
                          </div>
                        </div>
                      </div>
                    </div>
